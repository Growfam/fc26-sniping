    ...
    this.bot.action(/^platform_(.+)$/, async (ctx) => {
      ...
      if (state && state.step === 'add_account_platform') {
        ...
        await ctx.reply(
          '🍪 Надішліть cookies\n\n' +
          '📋 ІНСТРУКЦІЯ:\n\n' +
          '1. Відкрийте: ea.com/ea-sports-fc/ultimate-team/web-app\n' +
          '2. Увійдіть в EA акаунт\n' +
          '3. Зайдіть на ТРАНСФЕРНИЙ РИНОК і зробіть будь-який пошук\n' +
          '4. Натисніть F12 (відкриються DevTools)\n' +
          '5. Вкладка Network (Мережа)\n' +
          '6. У фільтрі напишіть: transfermarket\n' +
          '7. Натисніть на будь-який запит зі списку\n' +
          '8. Справа знайдіть Headers - Cookie\n' +
          '9. Скопіюйте ВСЕ що є в Cookie\n\n' +
          '✅ ПРИКЛАД що надіслати:\n' +
          '{"sid":"ut-sid-abc123...","personaId":"1234567890","nucleusId":"9876543210"}\n\n' +
          '─────────────────────\n' +
          '🤖 НЕ РОЗУМІЄТЕ? Простіший спосіб:\n\n' +
          '1. Скопіюйте ВСІ cookies з браузера\n' +
          '2. Відкрийте ChatGPT\n' +
          '3. Надішліть цей промпт:'
        );

        // Відправляємо промпт окремим повідомленням для легкого копіювання
        await ctx.reply(
          'Ось мої cookies з EA FC Web App. Витягни з них тільки sid, personaId та nucleusId і дай мені результат у форматі JSON: {"sid":"значення","personaId":"значення","nucleusId":"значення"}. Ось cookies:\n\n[ВСТАВТЕ СЮДИ ВАШІ COOKIES]'
        );

        await ctx.reply(
          '4. Вставте cookies замість [ВСТАВТЕ СЮДИ ВАШІ COOKIES]\n' +
          '5. ChatGPT дасть вам готовий JSON\n' +
          '6. Скопіюйте цей JSON і надішліть мені сюди'
        );
      }
    });
